...
// 全屏显示
        GraphicsEnvironment.getLocalGraphicsEnvironment()
                .getDefaultScreenDevice().setFullScreenWindow(d);
    }
...
class Deom extends JFrame {
    ...
    BufferedImage img = new BufferedImage((int) d.getWidth(),
...
// 设置透明度
    ...
    public void saveImg() throws IOException {
        ...
        BufferedImage saveImg =
                img.getSubimage((int) Math.min(sp.getX(), ep.getX()),
                        (int) Math.min(sp.getY(), ep.getY()),
