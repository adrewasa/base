...
import com.asa.base.data.xml.item.XmlListItem;
import com.asa.base.data.xml.node.XmlListNode;
...
import com.asa.base.utils.data.json.JsonUtils;
    ...
    public void characters(char[] ch, int start, int length, XmlNode node, Stack stack) {
        ...
        if (XmlItemUtils.isBaseXmlElement(cls)) {
            ...
            try {
                ...
                String methodName = AnnotationsUtils.getSetMethodName(node.getTagName());
